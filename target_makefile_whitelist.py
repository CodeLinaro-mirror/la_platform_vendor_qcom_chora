...
VENDOR_FOREACH_WHITELIST = {
    "device/qcom/common/utils.mk",
    "device/qcom/chora/chora.mk",
    "device/qcom/wlan/chora/BoardConfigWlan.mk",
    "device/qcom/wlan/chora/wlan.mk",
    "vendor/qcom/opensource/audio-hal/primary-hal/configs/chora/chora.mk",
...
VENDOR_SOONG_WHITELIST = {
    "device/qcom/chora/BoardConfig.mk",
